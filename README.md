...
* **수정 요청:** 보완이 필요한 경우 `more enhancement` 라벨이 부착되며, **Comment**를 통해 수정 요청이 전달됩니다. 수정 후 다시 Push하면 자동으로 PR에 반영됩니다. 과제물을 다시 제출했다면 `enhancement` 태그를 달아 주세요.
